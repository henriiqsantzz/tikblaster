...
const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ size = 'md', text, className, ...props }) => {
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center gap-3', className)} {...props}>
      <svg className={cn('animate-spin', sizeStyles[size])} fill="none" viewBox="0 0 24 24">
        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
        <path className="opacity-75 text-pink-500" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
      </svg>
...
const SkeletonCard: React.FC<SkeletonCardProps> = ({ count = 3, className, ...props }) => {
  return (
    <div className={cn('rounded-xl bg-white border border-gray-100 p-6 space-y-4 shadow-sm', className)} {...props}>
